...
@section('content')
    ...
    <div class="wrapper">
        <form class="form" id="form" action="admin/giangvien/them" method="post" enctype="multipart/form-data">
            <fieldset>
                <div class="widget">
                    <div class="title">
                    ...
                    <div class="tab_container">
                        <div id="tab1" class="tab_content pd0">
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <select style="width: 285px;" name="id_phong_thi_nghiem" _autocheck="true"
                                        ...
                                        @foreach($ptn as $kh)
                                            <option value="{{$kh->id_phong_thi_nghiem}}">{{$kh->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="clear"></div>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <select style="width: 285px;" name="id_bo_mon" _autocheck="true" id="param_cat"
                                        ...
                                        <option value="0"></option>
                                        @foreach($bomon as $kh)
                                            <option value="{{$kh->id_bo_mon}}">{{$kh->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="clear"></div>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <span><input name="email" id="param_name" _autocheck="true" type="text"></span>
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <select name="level" _autocheck="true" id="param_cat" class="left">
                                            ...
                                            <option value="3">Chủ nhiệm Khoa</option>
                                            <option value="4">Tổ chức cán bộ trường</option>
                                    </select>
                                </div>
                                <div class="clear"></div>
                            </div>
