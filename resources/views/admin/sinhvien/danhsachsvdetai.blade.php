    ...
    <div class="titleArea">
        <div class="wrapper">
            <div class="pageTitle">
                ...
                <span>Quản lý danh sách sinh viên được làm đề tài</span>
            </div>
            <div class="horControlB menu_action">
                <ul>
                    ...
                    <li><a href="admin/sinhvien/danhsachlamdetai">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck"
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="list_action itemActions">
                                <a href="admin/sinhvien/gui-mail-quyen-de-tai.html" class="button blueB">
                                    <span style='color:white;'>Gửi Mail cho sinh viên</span>
                                </a>
                            </div>
                    ...
                    @foreach($sinhvien as $sv)
                        <tr>
                            ...
                            <td class="option">
                                <a href="admin/sinhvien/huyquyendetai/{{$sv->id_sinh_vien}}" title="Hủy quyền đề tài">
