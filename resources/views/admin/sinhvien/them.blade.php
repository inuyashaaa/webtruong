...
@section('content')
    ...
    <div class="wrapper">
        <form class="form" id="form" action="admin/sinhvien/them" method="post" enctype="multipart/form-data">
            <fieldset>
                <div class="widget">
                    <div class="title">
                        ...
                        <div id="tab1" class="tab_content pd0">
                                ...
                                <div class="formRight">
                                    <select style="width: 285px;" name="id_khoa_hoc" _autocheck="true"
                                        ...
                                        @foreach($khoahoc as $kh)
                                            <option value="{{$kh->id_khoa_hoc}}">{{$kh->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="clear"></div>
                                ...
                                <div class="formRight">
                                    <select style="width: 285px;" name="id_nganh_hoc" _autocheck="true" id="param_cat"
                                        ...
                                        @foreach($nganhhoc as $kh)
                                            <option value="{{$kh->id_nganh_hoc}}">{{$kh->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="clear"></div>
                            ...
                            <div class="formRow">
                                <label class="formLeft" for="param_name">Mã Sinh viên:<span
                                            class="req">*</span></label>
                                <div class="formRight">
                                    <span><input name="id_sinh_vien" id="param_name" _autocheck="true"
                                                 type="text"></span>
                                </div>
                                <div class="clear"></div>
                            </div>
