...
function error_validate($errors)
{
    if (count($errors) > 0) {
        foreach ($errors->all() as $err) {
            echo "<div class='nNote nFailure hideit'>" . "<p><strong>" . "Lỗi:" . "</strong>" . $err . "</p></div>";
        }
    }
}
...
{
    if (session('message')) {
        echo "<div class=\"nNote nInformation hideit\"><p><strong>Thông báo: </strong>" . session('message') . "</p></div>";
    }
}
